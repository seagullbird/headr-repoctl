...
func New(svc service.Service, buf *bytes.Buffer) ServiceTest {
	var svctest ServiceTest
	{
		...
		svctest = EnvClearTestMiddleware()(svctest)
	}
	return svctest
}
...
func RunTests(t *testing.T, svctest ServiceTest) {
	t.Run("NewSite", func(t *testing.T) { svctest.TestNewSite(t) })
	t.Run("DeleteSite", func(t *testing.T) { svctest.TestDeleteSite(t) })
	t.Run("WritePost", func(t *testing.T) { svctest.TestWritePost(t) })
	t.Run("RemovePost", func(t *testing.T) { svctest.TestRemovePost(t) })
	t.Run("ReadPost", func(t *testing.T) { svctest.TestReadPost(t) })
}
